...
const TextAmountLayer = ({
  inputText, textColor, textTransformRef, editMode, setEditMode,
  canvasWidth = CANVAS_WIDTH, canvasHeight = CANVAS_WIDTH
}) => {
  ...
  useEffect(() => {
    ...
    textNode.y(canvasHeight - textNode.height() - TEXT_BOTTOM_PADDING);
  }, [ canvasHeight ]);
